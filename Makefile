...
ENGINE_SOURCES = $(ENGINE_DIR)/board.cpp $(ENGINE_DIR)/move_gen.cpp $(ENGINE_DIR)/uci.cpp $(ENGINE_DIR)/main.cpp $(ENGINE_DIR)/eval.cpp $(ENGINE_DIR)/search.cpp $(ENGINE_DIR)/zobrist.cpp
